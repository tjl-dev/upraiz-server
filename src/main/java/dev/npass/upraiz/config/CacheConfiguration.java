package dev.npass.upraiz.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.npass.upraiz.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.npass.upraiz.repository.UserRepository.USERS_BY_EMAIL_CACHE);
