...
import AccountReclaimRequestUpdateComponent from '@/entities/account-reclaim-request/account-reclaim-request-update.vue';
import AccountReclaimRequestClass from '@/entities/account-reclaim-request/account-reclaim-request-update.component';
...
describe('Component Tests', () => {
  describe('AccountReclaimRequest Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<AccountReclaimRequestClass>(AccountReclaimRequestUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.accountReclaimRequest = entity;
        accountReclaimRequestServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(accountReclaimRequestServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.accountReclaimRequest = entity;
        accountReclaimRequestServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(accountReclaimRequestServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        accountReclaimRequestServiceStub.retrieve.resolves([foundAccountReclaimRequest]);
